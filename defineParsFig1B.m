...
plot_hold           = 1;    % [0|1] overlay plots yes/no
...
wHppm   = [0:0.2:4];      % 1H offset in ppm wrt to 1H CW carrier, this needs to be varied to investigate the effect
...
% define dynamics
tca = [4 6.5 9]*1e-9;            % rotational correlation time [s]
...
offResonance        = 1;    % [0|1] include offResonance yes --- HAS TO BE 1!!
...
StartOp(4)  = 1;              % Hz=4 in Allard style matrix -- or should this be zero at the start of the 15N experiment, or shoudl it be aligned with the field!
